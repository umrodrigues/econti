      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full h-full px-4 sm:px-6 lg:px-8">
        <div className="absolute bottom-16 md:bottom-24 left-1/2 -translate-x-1/2">
          <a 
            ...
            className="inline-block bg-blue-600 hover:bg-blue-700 text-white text-base sm:text-lg lg:text-xl font-bold px-6 sm:px-7 lg:px-8 py-3 sm:py-3.5 lg:py-4 rounded-full transition-all duration-300 transform hover:scale-105 shadow-2xl"
          >
            Vamos Conversar!
          </a>
        </div>
